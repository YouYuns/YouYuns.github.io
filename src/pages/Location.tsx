      ...
      >
        <div className="location__info">
          ...
          <div className="location__dropdown">
            ...
            >
              <div>
                <div className="bold">[지하철]</div>
                <div>2호선, 5호선, 경의중앙선, 수인분당선</div>
                <div>왕십리역 6-1번 출구 (도보 2분)</div>
              </div>
              <div>
                <div className="bold">[버스]</div>
                <div>왕십리역 정류장 하차</div>
                <div>간선: 141, 145, 148, 421</div>
                <div>지선: 2014, 2016, 2222</div>
              </div>
            </div>
          </div>
          ...
          <div className="location__dropdown">
            ...
            >
              <div>
                <span className="icon">🚗</span>
                <span className="location_title">주차 안내</span>
              </div>
              <img
            ...
            >
              <div>
                <div className="bold">[주차장]</div>
                <div>비트플렉스 지하 주차장 이용</div>
                <div>(2시간 무료 주차 지원)</div>
              </div>
              <div>
                <div className="bold">[네비게이션]</div>
                <div>'디노체컨벤션' 또는</div>
                <div>'왕십리민자역사주차장' 검색</div>
              </div>
            </div>
          </div>
        </div>
